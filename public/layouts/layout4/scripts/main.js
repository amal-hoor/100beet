...
$(document).ready(function(){
    $('.upload-select').change(function () {
        ...
        // URL
        else if($(this).val() === 'url_upload'){
            $('.upload_type').empty();
            $('.upload_type').addClass("upload-url");
            $('.upload_type').append("<div class=\"row add-url-wrapper\">\n" +
                "                                            <div class=\"col-xs-12\">\n" +
                "                                                <input type=\"url\" class=\"form-control\" placeholder=\"add url here\" required>\n" +
                "                                                <span class=\"btn btn-add-url form-control\" id=\"btn_add_url\" onclick=\"add_url()\"><i class=\"fa fa-plus-circle\"></i> Add Another URL</span>\n" +
                "                                            </div>\n" +
                "                                        </div>");

            $("#btn_add_url").click(function () {
                $('.add-url-wrapper').append("<div class=\"col-xs-12\">\n" +
                    "                                                <input type=\"url\" class=\"form-control\" placeholder=\"add url here\">\n" +
                    "                                                <span class=\"btn btn-remove-url form-control\" id=\"btn_remove_url\" onclick=\"remove_url()\"><i class=\"fa fa-minus-circle\"></i> Remove URL</span>\n" +
                    "                                            </div>");
                $(".btn-remove-url").click(function(){
                    $(this).closest(".add-url-wrapper .col-xs-12").remove();
                });
            })
            function remove_url(){
                $(this).closest(".add-url-wrapper .col-xs-12").remove();
        ...
        // Browse
        else if($(this).val() === 'browse_upload'){
            $('.upload_type').empty();
            $('.upload_type').addClass("upload-browse");
            $('.upload_type').append("<div class=\"row browse-video-wrapper\">\n" +
                "                                            <div class=\"col-xs-12\">\n" +
                "                                                <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\n" +
                "                                                    <div class=\"fileinput-new thumbnail\" style=\"width: 200px; height: 150px;\">\n" +
                "                                                        <img src=\"http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=No+Video\" alt=\"\">\n" +
                "                                                    </div>\n" +
                "                                                    <div class=\"fileinput-preview fileinput-exists thumbnail\" style=\"max-width: 100%; max-height: 150px;\"></div>\n" +
                "                                                    <div>\n" +
                "                                                <span class=\"btn default btn-file\">\n" +
                "                                                    <span class=\"fileinput-new\"><i class=\"fa fa-file-video-o\"></i> Select Video </span>\n" +
                ...
                "                                            </div>\n" +
                "                                        </div>\n" +
                "                                        <span class=\"btn btn-add-video form-control\" id=\"btn_add_video\" onclick=\"add_video()\"><i class=\"fa fa-plus-circle\"></i> Add Another Video</span>");
            $("#btn_add_video").click(function () {
                $(".browse-video-wrapper").append("<div class=\"col-xs-12\">\n" +
                    "                                                <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\n" +
                    "                                                    <div class=\"fileinput-new thumbnail\" style=\"width: 200px; height: 150px;\">\n" +
                    "                                                        <img src=\"http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=No+Video\" alt=\"\">\n" +
                    "                                                    </div>\n" +
