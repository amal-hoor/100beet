                    ...
                    <div class="row">
                        <div class="col-11 m-auto">
                            ...
                            <div class="card mt-3">
                                ...
                                <form  method="POST" action="{{route('user.update',$user->id)}}" class="form-material m-t-40" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                            <input type="number" class="form-control form-control-line" name="mobile" value="{{$user->mobile}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class="form-control" name="submit" value="Update User">
                                    </div>
                                </form>
                            </div>
                        </div>
